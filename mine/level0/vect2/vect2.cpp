...
bool vect2::operator==(const vect2& other) const { return (a == other.a && b == other.b); }

bool vect2::operator!=(const vect2& other) const { return !(a == other.a && b == other.b); }

vect2 operator*(int value, const vect2& obj) { return obj * value; }
std::ostream& operator<<(std::ostream& ostr, const vect2& obj)
{
    return ostr << "{" << obj[0] << ", " << obj[1] << "}";
}